...
//	lstTuple.append(std::make_tuple(1, 3, QString::fromUtf8("糖糖糖")));
//	lstTuple.append(std::make_tuple(1, 4, QString::fromUtf8("烫烫烫")));
//	lstTuple.append(std::make_tuple(3, 2, QString::fromUtf8("烫烫烫")));
//	ret = TTextFile::InsertText("F:\\Data\\Test\\Zhongshan\\1.txt", lstTuple);
//
//	ret = TTextFile::InsertText("F:\\Data\\Test\\Zhongshan\\1.txt", 3, 3, QString::fromUtf8("糖糖糖"));
//
