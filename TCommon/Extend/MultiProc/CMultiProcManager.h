...
#ifndef _CMULTIPROCMANAGER_H_
#define _CMULTIPROCMANAGER_H_
#include <QMap>
#include <QMutex>
#include <QObject>
#include <QString>
...
private:
	...
	*/
	...
	当子进程崩溃时, 是否需要重启
	*/
	bool	m_bAutoRestartWhenCrash = false;
	...
	*/
	...
	int		m_iDenseInterval = 3000;	//密集间隔
	int		m_iLooseInterval = 10000;	//疏松间隔
};
#endif //_CMULTIPROCMANAGER_H_